...
```{r fifth_order_interpolating_polynomial}
x_values <- c(1, 2, 3, 4, 5, 6, 7, 8, 9)
y_values <- c(1, 1.5, 2, 3, 4, 5, 8, 10, 13)

ipol_table <- data.frame(x_values, y_values)
ipol_table[,"x^2"] <- ipol_table[,"x_values"]^2
ipol_table[,"x^3"] <- ipol_table[,"x_values"]^3
ipol_table[,"x^4"] <- ipol_table[,"x_values"]^4
ipol_table[,"xi^2yi"] <- ipol_table[,"x^2"] * ipol_table[,"x_values"]
ipol_table[,"yi"] <- ipol_table[,"x_values"]^2
